      ...
      <main>
        ...
        <section className="px-5 pb-4 flex justify-center w-full">
          ...
          <section className="">
              ...
              <section className="bg-gray-100 rounded-sm p-4 flex flex-col items-center">
                ...
                <div className="self-start flex flex-col gap-4">
                  ...
                  <RadioGroup defaultValue="option-one" >
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="option-one">Listar Pendentes</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="option-two" id="option-two" />
                      <Label htmlFor="option-two">Listar prontos</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="option-three" id="option-three" />
                      <Label htmlFor="option-three">Listar indeferidos</Label>
                    </div>
                  </RadioGroup>
