        ...
        <section className="px-2 sm:px-5 pb-4 flex flex-col md:flex-row md:justify-center w-full">
          ...
          <div className="mx-auto">
            <div className="w-[20rem] p-4 grid gap-4 sm:gap-2 sm:w-full lg:grid-cols-3 lg:grid-rows-[25rem_6rem_6rem]">
              ...
              {/* Banner */}
              <div tabIndex="0" aria-label="Banner descritivo: Faça parte do programa de embaixadores da impacta, é gratuito e exclusivo" className="hidden lg:col-span-2 sm:flex justify-center sm:mt-14 lg:justify-start">
                <img
                  src={banner}
